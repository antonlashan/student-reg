...
class UserDetail extends \yii\db\ActiveRecord {
    ...
    {
        return [
            [['user_id', 'present_position', 'permanent_address', 'phone_office', 'phone_mobile', 'professional_qualifications', 'qualifications', 'specializations'], 'required'],
            ...
            [['membership_number', 'member_category_id'], 'required', 'on' => self::SCENARIO_ACTIVATE]
        ];
    }
    ...
    {
        $data = $this->getOverdueLabels();
        return (isset($data[$this->payment_overdue]) ? $data[$this->payment_overdue] : null);
    }
